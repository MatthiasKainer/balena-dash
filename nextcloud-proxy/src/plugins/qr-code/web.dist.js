...
var id = "qr-code";
var qrModalTemplate = document.createElement('template');
var qrBasePath = "/".concat(id);
qrModalTemplate.innerHTML = "\n<link media=\"all\" rel=\"stylesheet\" href=\"".concat(qrBasePath, "/css\">\n  <div id=\"container\">\n        <div id=\"success-box\">\n            <div class=\"dot\"></div>\n            <div class=\"dot two\"></div>\n            <div class=\"message\">\n                <h1 class=\"alert\">This is the headline</h1>\n                <div id=\"qrCode\"></div>\n                <div id=\"url\"></div>\n            </div>\n            <button class=\"button-box\">\n                <h1 class=\"red\">Close Alert</h1>\n            </button>\n        </div>\n    </div>\n");

var QRCodeElement = /*#__PURE__*/function (_HTMLElement) {
  _inherits(QRCodeElement, _HTMLElement);
  ...
  function QRCodeElement() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(QRCodeElement).call(this));
    _this.root = _this.attachShadow({
      mode: "open"
    });

    _this.root.appendChild(qrModalTemplate.content.cloneNode(true));
    ...
    window.addEventListener("message", function (event) {
      var _event$data = event.data,
          ...
          url = _event$data.url;
      if (event.origin !== window.location.origin || event.source !== window || !url || type !== "matthias-kainer.DisplayUrl") return;
  ...
  _createClass(QRCodeElement, [{
    key: "_setBody",
    value: function _setBody(receivedUrl) {
...
window.customElements.define(id, QRCodeElement);