...
<link media="all" rel="stylesheet" href="${qrBasePath}/css">
  <div id="container">
        <div id="success-box">
            <div class="dot"></div>
...
class QRCodeElement extends HTMLElement {
    constructor() {
        ...
        this.root.appendChild(qrModalTemplate.content.cloneNode(true));
        this.container = this.root.querySelector("#container");
        this.container.style.display = "none";

        ["click"].forEach(eventType => {
            this.container.addEventListener(eventType, () => {
				this.shadowRoot.getElementById("qrCode").innerText = ""
                this.container.style.display = "none";
            });
        });
